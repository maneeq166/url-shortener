...
// import { createLink, getLinks as fetchLinks } from "../api/link"; import { toast } from "react-toastify";
...
//   if (homeLoad)
//     return (<div className="absolute top-1/2 right-1/2 text-center mt-10">
...
export default function Home() {
  ...
  const deleteLink = async (values) =>{
    const res = await deleteLinks(values);
    try {
